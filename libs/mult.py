        ...
        try:
            ...
            while not fin_cuenta:
                ...
                if int(resultado.text) == a * b:
                    ...
                    errores += 1
                    if error == 1:
                        texto.text = "Piensa un poco más ..."
                        sleep(1)
                        error -= 1
                    else:
                        texto.text = f"Te has equivocado, inténtalo otra vez"
                        sleep(1)
                        error += 1
                   
        except:
            texto.text = "Introduce un número "
            sleep(1)
            
    modificar_archivo()
    texto_multi.font_size = "100"
    texto.font_size = "100"  
